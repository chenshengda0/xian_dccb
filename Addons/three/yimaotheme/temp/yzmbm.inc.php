...
$rd=$config->getpwd();
?>
  <div class="right_center">>&nbsp;密码 + 密保验证</div>

  <div class="indent-r-top">密码 + 密保验证</div>
<form action="control.php" method="post" onsubmit="return chkmbm()"><input type="hidden" name="act" value="yzmbm" /><input type="hidden" name="m" value="<?php  echo $_GET['m']?>" /> <input type="hidden" name="yzform" value="ok" />     
