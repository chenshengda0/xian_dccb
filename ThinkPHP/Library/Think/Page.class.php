...
class Page{
    ...
    public function show() {
        ...
        if($this->totalRows>$this->listRows){
            ...
            $_arr = is_object($this->parameter) ? get_object_vars($this->parameter) : $this->parameter;
        	...
        	<span class="jump">转到第&nbsp;
        		<input type="text" id="inp"
        			onkeydown="javascript:if(event.keyCode==13){var page=(this.value>'.$this->totalPages.')?'.$this->totalPages.':this.value;
        			location=\''.$link.'/p/\'+page+\'\'}" value="'.$this->nowPage.'" >&nbsp;页<button style="cursor:pointer;" id="go" type="button"
        			onclick="javascript:var val=document.getElementById(\'inp\').value;var page =(val>'.$this->totalPages.')?'.$this->totalPages.':val;
        			location=\''.$link.'/p/\'+page+\'\'">GO</button></span>';
        }
        //替换分页内容
