...
class UserApi extends Api{
     ...
     * @param  array $userdata      待更新用户信息
     * @return int                  是否保存成功
     */
    public function updateMember($uid,$userdata){
    	return $this->model->updateMember($uid, $userdata);
    }
    ...
    public function updateMemberpsd( $uid,$data ){
    	return $this->model->updateMemberpsd($uid, $data);
    }
	...
	public function wechatlogin($openid){
		return $this->model->wechatlogin($openid);
	}
