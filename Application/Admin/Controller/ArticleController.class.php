...
class ArticleController extends AdminController {
    ...
    public function index($cate_id = null){
        ...
        if($cate_id===null){
        	$ids = D('Category')->getLeaf();
            $cate_id = !empty($this->cate_id)?$this->cate_id: $ids[0];
        }
        //获取模型信息
    ...
    protected function indexOfArticle($cate_id){
        ...
        $this->meta_title = get_category($cate_id, 'title');
        return 'index';
    }
    ...
    public function add(){
        ...
        $this->meta_title = '新增'.get_category_title($cate_id).$model['title'];
        $this->display();
    }
