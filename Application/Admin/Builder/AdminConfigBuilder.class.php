...
class AdminConfigBuilder extends AdminBuilder
{
    ...
    public function keyImages($name, $title, $subtitle = null)
    {
    
    	return $this->key($name, $title, $subtitle, 'images');
    }
    ...
    public function buttonSubmit($url = '', $title = '确定')
    {
        ...
        $attr = array();
        $attr['class'] = "btn btn-info ajax-post";
        $attr['id'] = 'submit';
        $attr['type'] = 'submit';
